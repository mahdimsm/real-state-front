    ...
    <div className="bg-white overflow-hidden group rounded-lg cursor-pointer shadow-lg ">
      <div className="relative">
        <Image
          ...
          height={300}
          className="w-full 
        object-cover group-hover:scale-110 transition-all duration-300"
        />
        ...
        <div
          className="flex items-center space-x-1 px-6 absolute top-4 left-4 py-2 text-sm bg-rose-600 w-
      ...
      <div className="p-5">
        ...
        <div className="w-full h-[1.2px] mt-4 bg-gray-500 opacity-15"></div>
